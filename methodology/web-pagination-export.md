...
PDF/DOCX exports are assets derived from publications. The source publication must have completed the **Publication Completion Checklist** in `methodology/documentation-generation.md#publication-completion-checklist` before exports are generated — front matter, viewer index, and link registry entries are prerequisites for a well-formed export.
