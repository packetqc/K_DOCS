...
See `methodology/methodology-project-management.md` (Dual-Origin Link System) for the full specification.
...
|---------|----------|------------|
| Dual-origin links | `methodology/methodology-project-management.md` | Core vs satellite link origins |
...
| Satellite bootstrap | `methodology/methodology-satellite-bootstrap.md` | How nodes join the network |
