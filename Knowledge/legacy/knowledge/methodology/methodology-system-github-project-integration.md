...
- `methodology/methodology-interactive-work-sessions.md` — Three-channel persistence model
- `methodology/methodology-tagged-input.md` — `#N:` scoped note convention
- `methodology/methodology-system-github-board-item-alias.md` — `g:<board>:<item>` convention
