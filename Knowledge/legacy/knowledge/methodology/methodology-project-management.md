...
|-------------|-------|------------------------|
| `methodology-satellite-bootstrap.md` | First-time satellite onboarding | Project registration as part of bootstrap |
| `methodology-project-create.md` | Web presence scaffolding (docs/) | Full entity creation (P# + repo + GitHub Project + web) |
| `methodology-tagged-input.md` | Scoped notes (`#N:`) | Notes route to project-indexed publications |
