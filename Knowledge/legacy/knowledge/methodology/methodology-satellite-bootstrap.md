...
1. Compare `<!-- knowledge-version: vN -->` in satellite vs `<!-- template-version: vN -->` in `/tmp/knowledge/methodology/methodology-satellite-commands.md`
2. If satellite version < core version:
   - Extract content between `<!-- BEGIN COMMANDS -->` and `<!-- END COMMANDS -->` markers from `methodology-satellite-commands.md`
...
`methodology/methodology-satellite-commands.md` is the single source of truth for the commands section. When core adds new commands:

1. Update `methodology-satellite-commands.md` (the canonical template)
2. Update `methodology-satellite-bootstrap.md` (the embedded template — for new scaffolds)
