...
These principles apply equally to `methodology-compilation-times.md` — both sheets share the same triggers and rules.
...
Enterprise ventilation is defined in detail in `methodology/methodology-compilation-times.md` (Enterprise Equivalent Ventilation section). The time file covers duration estimates; this file covers output/deliverable mapping. Both use the same 🔨/📝/🎓 icons for cross-referenceability.
...
- `methodology/methodology-compilation-times.md` — Time compilation routine (parallel sheet)
