"""SessionAgent — autonomous agent for GitHub issue sync.

Implements the autonomous background process that synchronizes
session events to GitHub issues via an event queue + timer + watchdog.
...
from .watchdog import Watchdog, STATE_FILE, QUEUE_FILE
