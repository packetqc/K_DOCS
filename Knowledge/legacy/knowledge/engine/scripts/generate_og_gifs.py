...
OUT_DIR = os.path.join(SCRIPT_DIR, '..', 'docs', 'assets', 'og')
REF_DIR = os.path.join(SCRIPT_DIR, '..', 'references', 'Martin')
...
THEMES = {
    'cayman': {
        'BG_TOP':        (239, 246, 255),     # #eff6ff  blue-50
        'BG_BOT':        (219, 234, 254),     # #dbeafe  blue-100
        'ACCENT_BLUE':   (29, 78, 216),       # #1d4ed8  blue-700
        'ACCENT_PURPLE': (59, 130, 246),      # #3b82f6  blue-500
        'ACCENT_CYAN':   (2, 132, 199),       # #0284c7  sky-600
        'ACCENT_GREEN':  (56, 189, 248),      # #38bdf8  sky-400
        'TEXT_WHITE':    (15, 23, 42),         # #0f172a  dark text on light bg
        'TEXT_MUTED':    (71, 85, 105),        # #475569
        'TEXT_DIM':      (107, 114, 128),      # #6b7280
        'BORDER':        (147, 197, 253),      # #93c5fd  blue-300
        'BOX_BG':        (239, 246, 255),      # #eff6ff  blue-50 box fill
        'CODE_BG':       (219, 234, 254),      # #dbeafe  blue-100
    },
    'midnight': {
        'BG_TOP':        (15, 23, 42),         # #0f172a  deep navy
        'BG_BOT':        (30, 27, 75),         # #1e1b4b  dark indigo
        'ACCENT_BLUE':   (96, 165, 250),       # #60a5fa  bright blue
        'ACCENT_PURPLE': (167, 139, 250),      # #a78bfa  bright purple
        'ACCENT_CYAN':   (34, 211, 238),       # #22d3ee  bright cyan
        'ACCENT_GREEN':  (74, 222, 128),       # #4ade80  bright green
        'TEXT_WHITE':    (226, 232, 240),       # #e2e8f0  light text on dark bg
        'TEXT_MUTED':    (148, 163, 184),       # #94a3b8
        'TEXT_DIM':      (100, 116, 139),       # #64748b
        'BORDER':        (51, 65, 85),          # #334155
        'BOX_BG':        (30, 41, 59),          # #1e293b  dark box fill
        'CODE_BG':       (51, 65, 85),          # #334155
    },
}

# Active theme state — set by set_theme()
CURRENT_THEME = 'cayman'
BG_TOP = THEMES['cayman']['BG_TOP']
BG_BOT = THEMES['cayman']['BG_BOT']
ACCENT_BLUE = THEMES['cayman']['ACCENT_BLUE']
ACCENT_PURPLE = THEMES['cayman']['ACCENT_PURPLE']
ACCENT_CYAN = THEMES['cayman']['ACCENT_CYAN']
ACCENT_GREEN = THEMES['cayman']['ACCENT_GREEN']
TEXT_WHITE = THEMES['cayman']['TEXT_WHITE']
TEXT_MUTED = THEMES['cayman']['TEXT_MUTED']
TEXT_DIM = THEMES['cayman']['TEXT_DIM']
BORDER = THEMES['cayman']['BORDER']
BOX_BG = THEMES['cayman']['BOX_BG']
CODE_BG = THEMES['cayman']['CODE_BG']
...
CARD_GROUPS = {
    ...
    'interfaces':   ['interfaces-hub', 'session-review', 'main-navigator'],
}
