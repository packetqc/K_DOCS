...
> **Page sommaire** : [Publication #10 — Réseau de connaissances en direct]({{ '/fr/publications/live-knowledge-network/' | relative_url }})

{% raw %}{% include_relative ../../../../publications/live-knowledge-network/v1/README.md %}{% endraw %}
