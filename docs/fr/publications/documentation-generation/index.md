...
> **Publication parente** : [#0 — Systeme de connaissances]({{ '/fr/publications/knowledge-system/' | relative_url }}) | **Companion structure** : [#6 — Normalize]({{ '/fr/publications/normalize-structure-concordance/' | relative_url }}) | **Companion pipeline** : [#17 — Pipeline de production web]({{ '/fr/publications/web-production-pipeline/' | relative_url }})
...
| **Heritage universel** | Chaque methodologie met a jour NEWS.md, PLAN.md, LINKS.md, CLAUDE.md, index |
