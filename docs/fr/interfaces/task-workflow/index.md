...
<div class="tw-toolbar">
  ...
  <a class="iface-info-btn" data-pub="guide-tasks-workflow" title="User Guide">ℹ</a>
</div>
...
(function(){
  ...
  btn.addEventListener('click', function(e) {
    ...
    if (window.parent !== window && window.name === 'center-frame') {
      window.parent.postMessage({ type: 'open-pub', url: pubUrl, title: 'Tasks Workflow Guide' }, '*');
    } else {
