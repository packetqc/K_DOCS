...
# Session Metrics & Time Compilation — Complete Documentation
{: #pub-title}

> **Summary**: [Publication #20]({{ '/publications/session-metrics-time/' | relative_url }}) | **Parent**: [#0 — Knowledge System]({{ '/publications/knowledge-system/' | relative_url }})
...
| [The Problem](#the-problem) | What gets lost, why it matters |
| [The Solution](#the-solution) | Category grid, metrics sheet, time sheet |
| [Live Example](#live-example-session-2026-02-26) | Full session compilation |
| [Methodology Integration](#methodology-integration) | Post-session routines |
| [Impact](#impact) | Before/after, design principles |
...
7. **Fill metrics grid** — populate the category x metrics table
...
6. **Fill time grid** — populate the category x time table
